...
tf_dicts = read_trained_data('../tf_dicts.pkl')
print (tf_dicts)
print (tf_dicts['nên'])
texts = []
intents_data = []
...
sentence = "tài khoản đuổi 1 còn bao nhiêu tiền"
...
if (num >= 0.5*(len(all_words)-num_stop_word)):
    ...
    with tf.Session() as sess:
        ...
        saver = tf.train.import_meta_graph('results/ANN_ver4/ws--embed-50batch_size_cl16.meta')
        saver.restore(sess,tf.train.latest_checkpoint('results/ANN_ver4/'))
